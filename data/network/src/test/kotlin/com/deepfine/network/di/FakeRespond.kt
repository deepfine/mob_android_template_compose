 ...
 */
enum class FakeRespond(private val encodedPath: String, val response: String) {
  Facts(
    encodedPath = "/facts",
    response = """
      {
  ...
  companion object {
    fun fromEncodedPath(encodedPath: String) = values().find { it.encodedPath == encodedPath }?.response
      ?: throw NotImplementedError("Not implemented test for $encodedPath")
  }
}
